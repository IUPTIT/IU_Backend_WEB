...
const schema = Joi.object({
  ...
  CANDIDATE_PORTAL_URL: Joi.string().uri().allow("").default("https://portal.iuptit.com/login"),
...
const config = {
  ...
  candidatePortalUrl: envVars.CANDIDATE_PORTAL_URL || "https://portal.iuptit.com/login",
